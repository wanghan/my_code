...
public class ConferenceSet implements Serializable {
	...
	private HashMap<String,Conference> nameConfenceMap;
	private HashMap<Integer,Conference> indexConfenceMap;
	private HashMap<Integer, String> globalIndexNameMap;
	private HashMap<String, Integer> globalNameIndexMap;
	private int index;
