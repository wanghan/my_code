...
function sub(str){
	...
	if(v.trim()=="")
	{      
		window.location.href="<%=path%>/SearchText/textSearch.jsp"; 
    	return false;
    }
    else
    	return true;   
...
<body onload="init('${tfe[0] }')">
	...
	<p>
		当前检索范围: <a href="<%=path %>/SearchText/textSearch.jsp">文本</a><label id="searchTypeC0">-${sessionScope.searchTypeC }</label>
	</p>
	<center>
