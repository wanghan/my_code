...
public interface SystemInstances11 {
	...
	public static int HQUserDeleteServPort=7105;              //总控端监听用户delete服务的端口
    public static int HQUserUpdateServPort=7106;             // 总控端监听用户update服务的端口
	//2、文本部分：
	...
	public static int HQLuceneDeleteServPort=7203; //总控端监听用户delete服务的端口
	public static int HQLuceneUpdateServPort=7204; //总控端监听用户update服务的端口
	...
	public static int HQVideoDeleteSerPort=7305;   //总控监听用户delete服务的端口
	public static int HQVideoUpdateSerPort=7306;   //总控监听用户update服务的端口
	...
	public static int HQAudioDeleteServPort=7403;  
	public static int HQAudioUpdateServPort=7404;
	...
	public static String VIDEO_IP="localhost";
	...
	public static final String VIDEO_FILE_INSERT_DIR = ".\\input\\";   
