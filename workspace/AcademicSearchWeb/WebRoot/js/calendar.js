...
document.write("#calendarTable thead a.today{width:50% !important; }");
document.write("#calendarTable thead a.today:hover{width:50% !important;}");
document.write("#calendarTable thead a.clear{width:50% !important; }");
document.write("#calendarTable thead a.clear:hover{width:50% !important;}");
...
function getDate(day){
   ...
   if(jjun_flag=="c"){
   		objInput.value = year + "年" + month + "月" + date + "日";
   }else{
