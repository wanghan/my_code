...
function showRelatedStampDialog(o,inner)
{
	...
	document.getElementById("avitShowName").innerHTML = "图像"+inner;
...
{
	var paths = new Array(
		"/AUDRweb/mainimage.html?rs=image",
		"/AUDRweb/TextSearch?rs=image",
		"/AUDRweb/AudioSearch?rs=image",
		"/AUDRweb/VideoSearch?rs=image"
		);
