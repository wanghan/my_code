...
function showRelatedStampDialog(o,inner)
{
	...
	var ob3 = document.getElementById("rs_glx3");
		ob3.length = 0;
	var ob4 = document.getElementById("rs_glx4");
		ob4.length = 0;
	for(i = 0;i<tm0.length;i++)
	{
		...
		ob4.appendChild(createOption(tm1[i],tm0[i]));
	}
	
	//document.getElementById("rs_data_type").value = v;
	
	document.getElementById("avitShowName").innerHTML = "音频"+inner;
...
{
	var paths = new Array(
		"/AUDRweb/mainimage.html?rs=audio",
		"/AUDRweb/TextSearch?rs=audio",
		"/AUDRweb/AudioSearch?rs=audio",
		"/AUDRweb/VideoSearch?rs=audio"
		);
