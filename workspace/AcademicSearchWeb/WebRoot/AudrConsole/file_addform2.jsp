...
SWFUpload.onload = function () {
	var settings = {
		...
		// Button Settings
		button_image_url : "<%=path %>/test/test/XPButtonUploadText_61x221.png",	// Relative to the SWF file
...
<!-- 添加文件 -->
	<div style="height: ;width: 700px;">
		...
		<input type="text" name="cf_u_txtv" id="cf_u_txtv" value="${sessionScope.username }">
		<input type="text" name="cfile_type" value="${filetye[n]  }">
		<input type="text" name="cfile_subtype" value="${fte[n][m] }">
		</form>
		<div id="file_addform_div_file">
		</div>
	</div>
  </body>
</html>
