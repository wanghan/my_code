...
//	public static String searchText = null;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		TextQueryResult[] results = (TextQueryResult[]) request.getSession().getAttribute("results");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		else 
		{
			...
			{
				RequestDispatcher disp = request.getRequestDispatcher("/common/ERROR.jsp");
					disp.forward(request, response);
			}
		}
		...
		try {
			System.out.println("results:"+searchText+"、bf、sf、"+searchType+"、"+userPath);
			results = uqTransporter.querybyKeywords
				(searchText, bf, sf, searchType, userPath); 
		} catch (Exception e) {
			// TODO: handle exception
		...
		request.getSession().setAttribute("totPage",(results.length-1)/pageSize+1);	//总页数
