...
//	private final static String SAVEPATH = "c:/textDown/";
	...
	out.println("  <BODY>");
	out.print("    下载失败，  ");
	out.print("	<a href='./AudrConsole/ConsoleMain.jsp'>返回</a>");
	out.println(" 谢谢！！！");
	out.println("  </BODY>");
	out.println("</HTML>");
	out.flush();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		map.put("image", "tools/audr_i.jar");
		map.put("text", "tools/audr_t.jar");
		map.put("audio", "tools/audr_a.jar");
		map.put("video", "tools/audr_v.jar");
		
		String filepath = servPath+"/"+map.get(id);
